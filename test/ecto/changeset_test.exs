defmodule Ecto.ChangesetTest do
  ...
  test "validate_length/3 with string" do
    ...
    assert changeset.errors == [
             title:
               {"should be at most %{count} character(s)",
                count: 4, validation: :length, kind: :max}
           ]
    ...
    assert changeset.errors == [
             title: {"should be %{count} character(s)", count: 10, validation: :length, kind: :is}
           ]
    ...
    assert changeset.errors == [
             title:
               {"should be at most %{count} character(s)",
                count: 1, validation: :length, kind: :max}
           ]
  end
  ...
  test "validate_length/3 with list" do
    ...
    assert changeset.errors == [
             topics:
               {"should have at most %{count} item(s)", count: 2, validation: :length, kind: :max}
           ]
    ...
    assert changeset.errors == [
             topics: {"should have %{count} item(s)", count: 10, validation: :length, kind: :is}
           ]
  ...
  test "validate_length/3 with associations" do
    ...
    assert changeset.errors == [
             comments:
               {"should have at least %{count} item(s)",
                count: 1, validation: :length, kind: :min}
           ]
  ...
  test "unsafe_validate_unique/3" do
    ...
    assert changeset.errors == [title: {"is taken", validation: :unsafe_unique, fields: [:title]}]
