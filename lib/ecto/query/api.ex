defmodule Ecto.Query.API do
  ...
  Without this function, columns from a fragment source must be defined
  within the fragment string such as:
  ...
  With this function you may create re-usable macros that allow for changing column names:
  ...
  Combining this function with splice can be particularly powerful as it allows
