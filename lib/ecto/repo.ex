defmodule Ecto.Repo do
  ...
  **Note this feature is experimental and may be changed or removed in future
  ...
  where `:key` is the key you are using in the `:placeholders` option map. To prevent
  ambiguous behavior, a placeholder key can only be used with columns of the same type.
