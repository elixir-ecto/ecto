defmodule Ecto.Repo do
  ...
  will look like this:
    ...
    * `:params` - the dumped query parameters (required by database drivers like Postgrex)
    * `:cast_params` - the casted query parameters (the normalized parameters, before dumping)
