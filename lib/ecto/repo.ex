defmodule Ecto.Repo do
  ...
  ## Options
    ...
    * `:returning` - selects which fields to return. It accepts a list
      ...
      supplied in the changeset. Any field not returned by the database
      will be present with the original value supplied by the user. Not
      all databases support this option and it may not be available during
      upserts. See the "Upserts" section for more information.
  ...
  ## Options
    ...
    * `:returning` - selects which fields to return. It accepts a list
      ...
      from the database overwrite what was supplied in the changeset. Any
      field not returned by the database will be present with the original
      value supplied by the user. Not all databases support this option.
