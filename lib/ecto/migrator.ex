defmodule Ecto.Migrator do
  ...
  """
  @spec migrated_versions(Ecto.Repo.t, atom) :: [integer]
  def migrated_versions(repo, prefix) do
    SchemaMigration.ensure_schema_migrations_table!(repo, prefix)
    SchemaMigration.migrated_versions(repo, prefix)
  end
  ...
  def up(repo, version, module, opts \\ []) do
    versions = migrated_versions(repo, Keyword.get(opts, :prefix, nil))
  ...
  defp do_up(repo, version, module, opts) do
    run_maybe_in_transaction repo, module, fn ->
      ...
      SchemaMigration.up(repo, version, Keyword.get(opts, :prefix, nil))
    end
  end
  ...
  defp do_down(repo, version, module, opts) do
    run_maybe_in_transaction repo, module, fn ->
      ...
      SchemaMigration.down(repo, version, Keyword.get(opts, :prefix, nil))
    end
  end
