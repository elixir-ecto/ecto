  ...
  defmacro timestamps(opts \\ []) do
    quote bind_quoted: binding do
      ...
      if inserted_at = Keyword.fetch!(timestamps, :inserted_at) do
        ...
        Module.put_attribute(__MODULE__, :ecto_autogenerate,
            {inserted_at, {Ecto.DateTime, :autogenerate, autogen}})
      end

      if updated_at = Keyword.fetch!(timestamps, :updated_at) do
        Ecto.Schema.field(updated_at, type, [])
        Module.put_attribute(__MODULE__, :ecto_autogenerate,
            {updated_at, {Ecto.DateTime, :autogenerate, autogen}})
        Module.put_attribute(__MODULE__, :ecto_autoupdate,
            {updated_at, {Ecto.DateTime, :autogenerate, autogen}})
      end
    end
  end
