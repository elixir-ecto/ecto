defmodule Ecto.Schema do
  ...
  * `__schema__(:autogenerate_id)` - Primary key that is auto generated on insert;
  ...
  defmacro __before_compile__(env) do
    unless Module.defines?(env.module, {:changeset, 2}) do
      message = """
      The function changeset/2 required by Ecto Schema does not exist \
      ...
      You can copy the implementation above or define your own.
      """
      ...
      cond do
        inserted_at && updated_at ->
          Module.put_attribute(
            __MODULE__,
            :ecto_autogenerate,
            {[inserted_at, updated_at], autogen}
          )
