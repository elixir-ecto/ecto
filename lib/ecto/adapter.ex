defmodule Ecto.Adapter do
  ...
  the adapter did not autogenerate one.
  ...
  `autogenerate_id` also allows drivers to detect if a value was assigned
  to a primary key that does not support update. In this case, `value`
  will be a non `nil` value.
  """
  ...
  If the value is `nil`, it means there is no autogenerated primary key.
  """
