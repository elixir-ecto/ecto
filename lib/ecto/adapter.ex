defmodule Ecto.Adapter do
  ...
  @doc """
  Returns a keyword list of query expressions in the order of traversal.

  This allows to account for adapter specific order of traversing query parts, which
  in turn affects e.g. order of extracted query parameters.
  """
  @callback expressions_for_traversal(atom :: :all | :update_all | :delete_all) :: term
