  ...
  defp on_conflict(on_conflict, conflict_target, schema_meta, counter_fun, adapter) do
    ...
    case on_conflict do
      ...
      :replace_all_except_primary_key ->
        ...
        IO.warn(
          ":replace_all_except_primary_key is deprecated, please use {:replace_all_except, [...]} instead"
        )
        ...
        fields =
          replace_all_fields!(
            :replace_all_except_primary_key,
            schema,
            schema && schema.__schema__(:primary_key)
          )
      ...
      {:error, :stale} ->
        ...
        case Keyword.fetch(opts, :stale_error_field) do
          {:ok, stale_error_field} when is_atom(stale_error_field) ->
            ...
            changeset =
              Changeset.add_error(changeset, stale_error_field, stale_message, stale: true)
