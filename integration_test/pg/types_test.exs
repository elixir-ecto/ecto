defmodule Ecto.Integration.TypesTest do
  ...
  test "datetime type" do
    ...
    c = TestRepo.insert(Comment.Entity[posted: now])
  ...
  test "date type" do
    ...
    c = TestRepo.insert(Comment.Entity[day: now])
  ...
  test "time type" do
    ...
    c = TestRepo.insert(Comment.Entity[time: now])
  ...
  test "interval type" do
    ...
    c = TestRepo.insert(Comment.Entity[interval: interval])
  ...
  test "binary type is hidden" do
    binary = << 0, 1, 2, 3, 4 >>
    c = TestRepo.insert(Comment.Entity[bytes: binary])
