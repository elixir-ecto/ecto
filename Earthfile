...
all-test:
    BUILD \
        --build-arg ELIXIR_BASE=1.13.0-erlang-24.3.4.2-alpine-3.16.0 \
        --build-arg ELIXIR_BASE=1.13.0-erlang-22.3.4.23-alpine-3.13.6 \
...
setup-base:
    ARG ELIXIR_BASE=1.13.0-erlang-24.3.4.2-alpine-3.16.0
